function windowcheck() {
    ...
    $('.main').css('min-height', window.innerHeight - ($('.topnav').height() + $('footer').height() + 90))
    $('.levels').css('min-height', window.innerHeight - ($('.topnav').height() + $('footer').height() + $('#search').height() + 90))
}